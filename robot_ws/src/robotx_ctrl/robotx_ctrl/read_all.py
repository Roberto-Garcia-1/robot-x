...
class ReadAll(Node):
    ...
    def timer_callback(self):
        ...
        #print("x: {:.4f}, y: {:.4f}, z: {:.4f}, gamma: {:.4f}, beta: {:.4f}, alpha: {:.4f}".format(x, y, z, degrees(gam), degrees(bet), degrees(al)))
        print("x: {:.4f}, y: {:.4f}, z: {:.4f}, gamma: {:.4f}, beta: {:.4f}, alpha: {:.4f}".format(x, y, z, gam, bet, al))
